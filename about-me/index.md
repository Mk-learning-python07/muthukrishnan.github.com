...
<div class="btn-row">
  <a href="{{ site.baseurl }}/professional-experience/" class="btn"><i class="fas fa-briefcase" aria-hidden="true"></i> My Experience</a>
  <a href="{{ site.baseurl }}/contact/" class="btn btn-outline"><i class="fas fa-envelope" aria-hidden="true"></i> Get in Touch</a>
</div>
