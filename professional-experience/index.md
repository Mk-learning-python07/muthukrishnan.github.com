...
description: Five years of upstream oil & gas process engineering at ExxonMobil.
permalink: /professional-experience/
---

<div class="exec-summary">
  <span class="exec-summary-label">Track Record</span>
  <p>Five years leading process engineering across offshore and remote upstream assets — from a $1.7M stack remediation led end-to-end, to $16M+ in cumulative risk mitigation through reliability programs, dynamic simulation, and safety-critical analysis.</p>
</div>

<div class="stat-row">
  <div class="stat"><span class="stat-num">5+</span><span class="stat-label">Years</span></div>
  <div class="stat"><span class="stat-num">$16M+</span><span class="stat-label">Value Delivered</span></div>
  <div class="stat"><span class="stat-num">2</span><span class="stat-label">Roles</span></div>
</div>
...
<div class="framework-grid">
  <div class="framework-card">
    ...
    <div class="framework-desc">Commissioned Electrical Tomography 3-phase level tech at Hebron — findings informed org-wide evaluation against incumbent Nuclear Level technology.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">02</span>
    <div class="framework-title">Project Leadership</div>
    <div class="framework-desc">Led a $1.7M exhaust-stack remediation at Hebron from scope definition through offshore execution — on time, within budget.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">03</span>
    <div class="framework-title">Process Safety</div>
    <div class="framework-desc">Led an H&#8322;S consequence analysis for Hibernia that deferred fixed gas detection installation, saving $3M.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">04</span>
    <div class="framework-title">Asset Risk &amp; Mitigation</div>
    <div class="framework-desc">Mitigated $11.7M in asset risk by implementing a risk-based maintenance and sparing philosophy for control valves at Hibernia.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">05</span>
    <div class="framework-title">Process Modelling</div>
    <div class="framework-desc">Cut OPEX by $50K/yr for Hibernia through Aspen HYSYS-based TEG-loss investigation and gas-lift system baselining.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">06</span>
    <div class="framework-title">Process Surveillance &amp; Monitoring</div>
    <div class="framework-desc">Realized $4.2M in cumulative savings from anomaly detection and exception-based process monitoring, East Area Projects.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">07</span>
    <div class="framework-title">GHG Mitigation</div>
    <div class="framework-desc">Quantified CO&#8322;(eq) abatement for a flare reduction opportunity — CAD 15.2M @ NPV8% on carbon credits — and initiated the concept study with EPC.</div>
  </div>
  <div class="framework-card">
    <span class="framework-num">08</span>
    <div class="framework-title">Data Engineering &amp; ML</div>
    <div class="framework-desc">Built first-principles and machine-learning fouling models to predict cleaning schedules at the PNG Hides Gas Plant.</div>
  </div>
</div>
...
<div class="callout">
  <strong>Flagship Project &mdash; MPG-A Exhaust Stack Remediation ($1.7M)</strong><br>
  Led from scope definition through offshore execution — coordinating HAZOP, a full Management of Change process, and cross-functional teams — delivered on time and within budget.
</div>
...
<div class="btn-row">
  <a href="{{ site.baseurl }}/Files/MA_Resume_Apr2026.pdf" class="btn"><i class="fas fa-file-arrow-down" aria-hidden="true"></i> Download Resume</a>
</div>
