...
- Achievements or metrics (e.g., "Increased sales by 30% over 6 months").
...
Click <b>[here]({{ site.baseurl }}/Files/MA_Resume_Apr2026.pdf)</b> to view my resume.

<div class="timeline-container">
  <!-- Timeline Item 1 
  <div class="timeline-item" id="item-1">
    <div class="timeline-marker" data-target="#item-1">
    <div>2018</div></div>
    <div class="timeline-content">
      <h3>Research Intern</h3>
      <p><strong>Institute of Drilling Technology, Oil and Natural Gas Corporation of India (ONGC) </strong></p>
       <p><strong>Duration:</strong> May - Jul 2018</p>
        <p><strong>Location:</strong> Dehradun, India</p>
        <p>
            • Designed thermally stable drilling fluid formulations for commercial operations that involved high-temperature applications (up to 100°C).<br>
            • Conducted field feasibility assessments on the fluid formulations by performing tests in accordance with API standards.<br>
            • Attained working knowledge of different additives and performance measures for testing drilling fluids.
        </p>
        <p><span style="color: #28a745;"><strong>Key Items:</strong></span><i> Drilling Fluids, API Standards, High-Temperature Applications, Thermal Stability, Fluid Rheology, Drilling Fluid Additives and Stability and Oil & Gas Exploration</i></p>
    </div>
  </div> -->

  <!-- Timeline Item 2 
  <div class="timeline-item" id="item-2">
    <div class="timeline-marker" data-target="#item-2">2019</div>
    <div class="timeline-content">
      <h3>Undergraduate Thesis</h3>
      <p><strong>National Institute of Technology, Tiruchirappalli (NITT)</strong></p>
       <p><strong>Duration:</strong> Jan - Apr 2019</p>
        <p><strong>Location:</strong> Tiruchirappalli, India</p>
      <p>
    • Conducted literature review on grade-2 Biorefinery concept and 2,5-Furan Di-Carboxylic Acid (FDCA) biopolymer production. <br>
    • Evaluated the practicality of expanding lab-scale production to an industrial level. <br>
    • Performed overall Heat and Material balances, provided cost estimates and high-level equipment sizing for the major equipment involved in production process.<br>
</p>
      <p><span style="color: #28a745;"><strong>Key Items:</strong></span><i> Grade-2 Biorefinery, Hydroxymethylfurfural (HMF), 2,5-Furan Di-Carboxylic Acid (FDCA), Heat and Mass Balances and Equipment Sizing</i></p>
    </div>
  </div>-->
...
•	Collaborated with <b>Technical SMEs</b> to perform sensitivity checks using <b>HYSYS Dynamic simulations</b> to replicate operational conditions during the Gas Lift restart for GL Flowlines. This work clarified that the exceedance in MDMT temperatures is not a Critical Operating Parameter, thereby mitigating a potential High consequence (HC1/HC2) risk in the flowlines.<br>
</p>
...
/* Active state of the timeline marker */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("scroll", function () {
    ...
    items.forEach((item, index) => {
      ...
      // Ensure last item gets highlighted properly
